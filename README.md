...
5. `uv run main.py` または `python main.py`
6. 出来上がった `results.json` を `viewer/` 内にコピー
7. `cd viewer` したら `uv run python -m http.server 8000` または `python -m http.server 8000`
8. http://localhost:8000 で確認
